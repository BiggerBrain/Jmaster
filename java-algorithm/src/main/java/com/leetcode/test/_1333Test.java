...
import com.leetcode.solutions._1333;
...
public class _1333Test {
    ...
    @Test
    public void test1() {
        restaurants = new int[][] { { 1, 4, 1, 40, 10 }, { 2, 8, 0, 50, 5 }, { 3, 8, 1, 30, 4 },
    ...
    public void test2() {
        restaurants = new int[][] { { 1, 4, 1, 40, 10 }, { 2, 8, 0, 50, 5 }, { 3, 8, 1, 30, 4 },
                                    { 4, 10, 0, 10, 3 }, { 5, 1, 1, 15, 1 } };
        assertEquals(Arrays.asList(4, 3, 2, 1, 5),
            solution1.filterRestaurants(restaurants, 0, 50, 10));
    }
