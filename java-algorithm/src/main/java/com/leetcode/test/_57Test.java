...
import com.leetcode.solutions._57;
...
public class _57Test {
    ...
    @Test
    public void test2() {
        intervals = new ArrayList<>(Arrays.asList(new Interval(1, 2), new Interval(3, 5),
    ...
    public void test8() {
        intervals = new ArrayList<>(
            Arrays.asList(new Interval(2, 5), new Interval(6, 7), new Interval(8, 9)));
        expected = new ArrayList<>(Arrays.asList(new Interval(0, 1), new Interval(2, 5),
    ...
    @Test
    public void test9() {
        intervals = new ArrayList<>(Arrays.asList(new Interval(2, 4), new Interval(5, 7),
            new Interval(8, 10), new Interval(11, 13)));
        expected = new ArrayList<>(
            Arrays.asList(new Interval(2, 7), new Interval(8, 10), new Interval(11, 13)));
        CommonUtils.printIntervals(intervals);
