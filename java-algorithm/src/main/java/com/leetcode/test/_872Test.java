...
import com.leetcode.solutions._872;
...
public class _872Test {
    ...
    public void test2() {
        root1 = TreeUtils
            .constructBinaryTree(Arrays.asList(18, 35, 22, null, 103, 43, 101, 58, null, 97));
        TreeUtils.printBinaryTree(root1);
        root2 = TreeUtils
            .constructBinaryTree(Arrays.asList(94, 102, 17, 122, null, null, 54, 58, 101, 97));
        TreeUtils.printBinaryTree(root2);
