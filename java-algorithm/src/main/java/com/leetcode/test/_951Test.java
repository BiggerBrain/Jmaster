...
import com.leetcode.solutions._951;
...
public class _951Test {
    ...
    @Test
    public void test1() {
        TreeNode root1 = TreeUtils
            .constructBinaryTree(Arrays.asList(1, 2, 3, 4, 5, 6, null, null, null, 7, 8));
        TreeNode root2 = TreeUtils.constructBinaryTree(
