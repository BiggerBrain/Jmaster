...
import com.leetcode.solutions._734;
...
public class _734Test {
    ...
    public void test1() {
        ...
        pairs = new String[][] { { "great", "fine" }, { "acting", "drama" },
                                 { "skills", "talent" } };
    ...
    public void test2() {
        ...
        String[][] pairs = new String[][] { { "great", "good" }, { "extraordinary", "good" },
                                            { "well", "good" }, { "wonderful", "good" },
                                            { "excellent", "good" }, { "dinner", "meal" },
                                            { "fine", "good" }, { "nice", "good" },
                                            { "any", "one" }, { "unique", "one" },
                                            { "some", "one" }, { "the", "one" }, { "an", "one" },
                                            { "single", "one" }, { "a", "one" }, { "keep", "own" },
                                            { "truck", "car" }, { "super", "very" },
                                            { "really", "very" }, { "actually", "very" },
                                            { "extremely", "very" }, { "have", "own" },
                                            { "possess", "own" }, { "lunch", "meal" },
                                            { "super", "meal" }, { "food", "meal" },
                                            { "breakfast", "meal" }, { "brunch", "meal" },
                                            { "wagon", "car" }, { "automobile", "car" },
                                            { "auto", "car" }, { "fruits", "meal" },
