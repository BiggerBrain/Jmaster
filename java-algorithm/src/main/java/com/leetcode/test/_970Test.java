...
import com.leetcode.solutions._970;
...
public class _970Test {
    ...
    @Test
    public void test5() {
        assertEquals(Arrays.asList(2, 91, 180, 8101, 8190, 16200, 729001, 729090, 737100),
            solution1.powerfulIntegers(90, 90, 1000000));
        List<Integer> actual = solution2.powerfulIntegers(90, 90, 1000000);
        Collections.sort(actual);
        assertEquals(Arrays.asList(2, 91, 180, 8101, 8190, 16200, 729001, 729090, 737100), actual);
    }
}
