...
import com.leetcode.solutions._1418;
...
public class _1418Test {
    ...
    @Test
    public void test1() {
        orders = Arrays.asList(Arrays.asList("Laura", "2", "Bean Burrito"),
            Arrays.asList("Jhon", "2", "Beef Burrito"), Arrays.asList("Melissa", "2", "Soda"));
        expected = Arrays.asList(Arrays.asList("Table", "Bean Burrito", "Beef Burrito", "Soda"),
    ...
    @Test
    public void test2() {
        orders = Arrays.asList(Arrays.asList("James", "12", "Fried Chicken"),
        ...
        expected = Arrays.asList(Arrays.asList("Table", "Canadian Waffles", "Fried Chicken"),
            Arrays.asList("1", "2", "0"), Arrays.asList("12", "0", "3"));
        assertEquals(expected, solution1.displayTable(orders));
    }

    @Test
    public void test3() {
        orders = Arrays.asList(Arrays.asList("David", "3", "Ceviche"),
        ...
        expected = Arrays.asList(
            ...
            Arrays.asList("3", "0", "2", "1", "0"), Arrays.asList("5", "0", "1", "0", "1"),
