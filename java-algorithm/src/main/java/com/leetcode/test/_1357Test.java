...
import com.leetcode.solutions._1357;
...
public class _1357Test {
    ...
    @Test
    public void test1() {
        cashier = new _1357.Solution1.Cashier(3, 50, new int[] { 1, 2, 3, 4, 5, 6, 7 },
        ...
        assertEquals(7350.0, cashier.getBill(new int[] { 7, 5, 3, 1, 6, 4, 2 },
            new int[] { 10, 10, 10, 9, 9, 9, 7 }), 0);
