...
import com.leetcode.solutions._1373;
...
public class _1373Test {
    ...
    public void test5() {
        ...
        root = TreeUtils.constructBinaryTree(
            Arrays.asList(1, 4, 3, 2, 4, 2, 5, null, null, null, null, null, null, 4, 6));
        TreeUtils.printBinaryTree(root);
    ...
    public void test6() {
        solution1 = new _1373.Solution1();
        root = TreeUtils.constructBinaryTree(
            Arrays.asList(4, 8, null, 6, 1, 9, null, -5, 4, null, null, null, -3, null, 10));
        TreeUtils.printBinaryTree(root);
