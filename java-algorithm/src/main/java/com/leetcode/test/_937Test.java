...
import com.leetcode.solutions._937;
...
public class _937Test {
    ...
    @Test
    public void test1() {
        logs = new String[] { "a1 9 2 3 1", "g1 act car", "zo4 4 7", "ab1 off key dog",
                              "a8 act zoo" };
        expected = new String[] { "g1 act car", "a8 act zoo", "ab1 off key dog", "a1 9 2 3 1",
                                  "zo4 4 7" };
