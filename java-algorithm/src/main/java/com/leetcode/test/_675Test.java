...
import com.leetcode.solutions._675;
...
public class _675Test {
    ...
    public void test4() {
        forest = ArrayUtils
            .buildList(new int[][] { { 2, 3, 4, 9 }, { 0, 0, 5, 10 }, { 8, 7, 6, 12 }, });
        assertEquals(13, solution1.cutOffTree(forest));
    }

    @Test
    public void test5() {
        forest = ArrayUtils.buildList(
            new int[][] { { 0, 0, 0, 3528, 2256, 9394, 3153 },
                          { 8740, 1758, 6319, 3400, 4502, 7475, 6812 },
                          { 0, 0, 3079, 6312, 0, 0, 0 }, { 6828, 0, 0, 0, 0, 0, 8145 },
                          { 6964, 4631, 0, 0, 0, 4811, 0 }, { 0, 0, 0, 0, 9734, 4696, 4246 },
                          { 3413, 8887, 0, 4766, 0, 0, 0 }, { 7739, 0, 0, 2920, 0, 5321, 2250 },
    ...
    @Test
    public void test6() {
        forest = ArrayUtils.buildList(new int[][] { { 54581641, 64080174, 24346381, 69107959 },
