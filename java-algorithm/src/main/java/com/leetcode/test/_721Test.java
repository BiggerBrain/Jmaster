...
import com.leetcode.solutions._721;
...
public class _721Test {
    ...
    public void test1() throws Exception {
        ...
        List<String> expected2 = new ArrayList<>(Arrays.asList("John", "john00@mail.com",
    ...
    private void assertEqualsIgnoreOrdering(List<List<String>> expected,
                                            List<List<String>> actual) throws Exception {
    ...
    public void test3() throws Exception {
        ...
        expected = new ArrayList<>();
        List<String> expected1 = new ArrayList<>(Arrays.asList("David", "David0@m.co",
