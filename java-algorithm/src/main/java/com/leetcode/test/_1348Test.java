...
import com.leetcode.solutions._1348;
...
public class _1348Test {
    ...
    public void test3() {
        ...
        assertEquals(Arrays.asList(0),
            tweetCounts.getTweetCountsPerFrequency("day", "tweet0", 89, 9471));
        assertEquals(Arrays.asList(2, 0),
            tweetCounts.getTweetCountsPerFrequency("hour", "tweet3", 13, 4024));
    }
}