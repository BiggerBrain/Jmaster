...
import com.leetcode.solutions._690;
...
public class _690Test {
    ...
    @Test
    public void test1() {
        employees = new ArrayList(Arrays.asList(new Employee(1, 5, Arrays.asList(2, 3)),
            new Employee(2, 3, Arrays.asList()), new Employee(3, 3, Arrays.asList())));
        id = 1;
    ...
    public void test2() {
        employees = new ArrayList(Arrays.asList(new Employee(1, 5, Arrays.asList(2, 3)),
            new Employee(2, 3, Arrays.asList(4)), new Employee(3, 4, Arrays.asList()),
