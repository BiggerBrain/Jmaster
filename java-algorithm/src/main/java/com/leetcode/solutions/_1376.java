...
public class _1376 {
    public static class Solution1 {
        ...
        private void backtracking(boolean[] visited, int managerId, int currentMinutes,
                                  int[] informTime, Set<Integer> managerIdSet,
                                  Set<Integer> visitedEmployees, Map<Integer, List<Integer>> map) {
            ...
            if (map.containsKey(managerId)) {
                ...
                for (int subordinate : suboridnates) {
                    if (!visited[subordinate]) {
                        backtracking(visited, subordinate, currentMinutes + informTime[managerId],
                            informTime, managerIdSet, visitedEmployees, map);
                    }
                }
            }
        }
