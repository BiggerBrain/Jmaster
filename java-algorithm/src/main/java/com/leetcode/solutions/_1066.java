...
public class _1066 {
    public static class Solution1 {
        ...
        private void backtracking(int[][] workers, int[][] bikes, int workersIndex,
                                  boolean[] bikesAssigned, int currentSum) {
            ...
            for (int j = 0; j < bikes.length; j++) {
                if (!bikesAssigned[j]) {
                    ...
                    backtracking(workers, bikes, workersIndex + 1, bikesAssigned,
