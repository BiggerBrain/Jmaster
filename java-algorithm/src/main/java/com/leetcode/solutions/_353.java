...
public class _353 {
    public class SnakeGame {
        private final Set<Integer>   set;      //Use a set to hold all occupied points for the snake body, this is for easy access for the case of eating its own body
        private final Deque<Integer> body;     //use a queue to hold all occupied points for the snake body as well, this is for easy access to update the tail
        int[][]                      food;
        int                          score;
        int                          foodIndex;
        int                          width;
        ...
        public int move(String direction) {
            ...
            if (set.contains(newHead) || rowHead < 0 || colHead < 0 || rowHead >= height
                || colHead >= width) {
                return score = -1;
            }
