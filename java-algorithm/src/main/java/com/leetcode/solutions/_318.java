...
public class _318 {
    public static void main(String... strings) {
        ...
        for (int j = 0; j < sample.length(); j++) {
            ...
            System.out
                .println("nonShiftLeft = " + shiftLeftByHowMany + "\tnonShiftLeft binary form is: "
                         + Integer.toBinaryString(shiftLeftByHowMany) + "\nshiftLeft = "
                         + shiftLeftResult + "\tshiftLeft binary form is: "
                         + Integer.toBinaryString(shiftLeftResult) + "\nbits = " + bits
                         + "\tbits binary form is: " + Integer.toBinaryString(bits));
